        ...
        <div class="app-container">
            <div class="app-header">
                ...
                <div class="app-sidebar">
                    <a href="dashboard-petugas" class="app-sidebar-link" title="Dashboard">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                        <polyline points="9 22 9 12 15 12 15 22" /></svg>
                        </a>
                        <a href="penjualan" class="app-sidebar-link active" title="customer List">
                            ...
                            <tr data-target="#purchaseModal" data-toggle="modal" class="nama-box">
                                <td>{{$loop->iteration}}
                                    ...
                                    <span class="badge badge-warning">
                                        New Update
                                        <br>
                                        <span class="text-muted" style="font-size: 10px">at: {{$value->updated_at->setTimezone('Asia/Jakarta')->format('H:i a')}}</span>
                                    </span>
                                    @endif
                                </td>
                                ...
                                <td>Burger, Pizza</td>
                                <td>
                                   <center> {{$value->created_at->isoFormat('D MMMM  YYYY')}} <br></center>
                                  <center>{{$value->created_at->setTimezone('Asia/Jakarta')->format('H:i a')}}</center>
                                </td>
                            </tr>
